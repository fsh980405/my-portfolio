...
const ScrollStack = ({
  ...
  const updateCardTransforms = useCallback(() => {
    if (!cardsRef.current.length || isUpdatingRef.current || !isOpen) return;
  ...
  return createPortal(
    <div className={styles.overlay} onClick={onClose}>
      ...
      <div className={`${styles.scrollStackScroller} ${className}`.trim()} ref={scrollerRef} onClick={(e) => e.stopPropagation()}>
